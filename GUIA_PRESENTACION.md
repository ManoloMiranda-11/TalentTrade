...
El seed crea **ocho usuarios** de demostración; Ana y Carlos son los principales, y el resto (Lucía, Marta, Javier, Diego…) hacen que la pantalla *Descubrir* tenga propuestas compatibles que enseñar.
...
## Demo En Vivo: Regístrate Tú Mismo

Para enseñar que nada está fijo, crea tu propio usuario en directo durante la presentación:

```text
Nombre: Manuel Miranda
Correo: manuel.miranda@talenttrade.es
Contraseña: 123456
Ciudad: (la tuya)
Biografía: Desarrollador y autor de TalentTrade. Ofrezco programación y quiero mejorar mi inglés.
```

Habilidades recomendadas:

- Ofrece: Programación, nivel Avanzado.
- Quiere aprender: Inglés, nivel Inicial.

Después:

1. Guarda tu perfil.
2. Añade tus habilidades.
3. Ve a Descubrir.
4. Aparecerán **Carlos y Lucía** como compatibles (ofrecen Inglés y quieren Programación).
5. Crea la propuesta de intercambio con uno de ellos.
6. Entra con Carlos o Lucía, acepta la solicitud y abre el chat para enseñar la otra parte del flujo.
