...
5. Carga las habilidades iniciales y los usuarios de demo:

```bash
npm run prisma:seed
```

El seed crea 30 habilidades, 8 usuarios de demo (todos con la contraseña `123456`) y 2 coincidencias ya preparadas. La protagonista es Ana García (`ana.garcia@talenttrade.es`): entra con una coincidencia aceptada con Carlos Martín (incluido el chat) y una solicitud pendiente de Diego Romero, de modo que la demo se puede mostrar sin tocar nada más.
...
Los 8 usuarios de demo comparten la contraseña `123456`. Ana García es la protagonista de la demostración:

| Nombre | Correo | Ofrece | Quiere aprender |
| --- | --- | --- | --- |
| Ana García | `ana.garcia@talenttrade.es` | Programación, Diseño UX/UI | Inglés, Fotografía, Guitarra |
| Carlos Martín | `carlos.martin@talenttrade.es` | Inglés | Programación |
| Lucía Fernández | `lucia.fernandez@talenttrade.es` | Inglés | Programación |
| Javier Ruiz | `javier.ruiz@talenttrade.es` | Fotografía | Diseño UX/UI |
| Marta Soler | `marta.soler@talenttrade.es` | Guitarra | Programación |
| Diego Romero | `diego.romero@talenttrade.es` | Inglés | Diseño UX/UI |
| Sergio Navarro | `sergio.navarro@talenttrade.es` | Programación | Inglés |
| Elena Castro | `elena.castro@talenttrade.es` | Programación | Inglés |

Entrando como Ana ya existe una coincidencia aceptada con Carlos (con su chat) y una solicitud pendiente de Diego, así que el chat y la programación de sesiones pueden mostrarse sin pasos previos.
